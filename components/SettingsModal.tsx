         ...
         <div className="bg-white rounded-[2rem] shadow-2xl w-full max-w-lg relative z-10 animate-fade-in-up overflow-hidden">
            ...
            <div className="px-8 py-6 border-b border-gray-100 flex items-center justify-between bg-gray-50/50">
               <div className="flex items-center gap-4">
                  ...
                  <div>
                     <h3 className="text-xl font-extrabold text-gray-900">Model & API Key Settings</h3>
                     <p className="text-sm text-gray-500 font-medium">Configure AI for your application</p>
                  </div>
               </div>
